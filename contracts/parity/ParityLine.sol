...
contract ParityLine is AccessControlEnumerable {
    ...
    function ConvertRisk(
        ...
        returns (
            uint256 _return,
            uint256 _weight_alpha,
            uint256 _weight_beta,
            uint256 _weight_gamma
        )
    {
        require(
    ...
    function ConvertWeights(
        ...
        uint256 _weight_beta,
        uint256 _weight_gamma
    ) public view returns (uint256 _risk, uint256 _return) {
        _return = (_weight_alpha *
            r_a +
            _weight_beta *
            r_b +
            _weight_gamma *
