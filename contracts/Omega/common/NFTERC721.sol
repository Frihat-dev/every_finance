    ...
    Pausable
{
    ...
    /// @dev This function checks whether the contract supports the given interface by delegating the call to the inherited contracts ERC1155Upgradeable, ERC1155Holder, ERC721Holder and AccessControlEnumerable.
